...
import "../Styles/pages/TermAndCondition.css";
  ...
  return (
    <>
      <div className="term--container">
        <div className="term--container__heading">
          <div className="term__imgContainer">
            <img src={logo} alt="" />
          </div>
        ...
        <p>
          The terms hilora "We" / "Us" / "Our"/”Company” individually and
          collectively refer to Loop Techno Systems pvt ltd and the terms
          "Visitor” ”User” refer to the users. <br /> <br /> This page states
          the Terms and Conditions under which you (Visitor) may visit this
          website (“hiloramart.com”). Please read this page carefully. If you do
          not accept the Terms and Conditions stated here, we would request you
          to exit this site. The business, any of its business divisions and /
        ...
        <p>
          ...
          site content, is strictly prohibited. <br />
        ...
        <p style={{fontWeight: 'bold', marginBottom: 0}}>(A) Security Rules : - </p>
        <p>
        ...
        <p style={{fontWeight: 'bold', marginBottom: 0}}>(B) General Rules : - </p>
        <p>
        Visitors are prohibited from violating or attempting to violate the security of the Web site, including, without limitation, (1) accessing data not intended for such user or logging into a server or account which the user is not authorised to access, (2) attempting to probe, scan or test the vulnerability of a system or network or to breach security or authentication measures without proper authorisation, (3) attempting to interfere with service to any user, host or network, including, without limitation, via means of submitting a virus or "Trojan horse" to the Website, overloading, "flooding", "mail bombing" or "crashing", or (4) sending unsolicited electronic mail, including promotions and/or advertising of products or services. Violations of system or network security may result in civil or criminal liability. The business and / or its associate entities will have the right to investigate occurrences that they suspect as involving such violations and will have the right to involve, and cooperate with, law enforcement authorities in prosecuting users who are involved in such violations.
        </p>
        ...
        <h5>INDEMNITY: </h5>
        <p>
        The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of www.hiloramart.com or their breach of the terms .
        </p>
